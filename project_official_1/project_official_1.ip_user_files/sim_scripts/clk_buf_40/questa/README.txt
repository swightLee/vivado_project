...
#
# Generated by export_simulation on Mon Apr 15 14:56:40 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './clk_buf_40.sh' script.

./clk_buf_40.sh -reset_run
...
./clk_buf_40.sh -noclean_files

For more information on the script, please type './clk_buf_40.sh -help'.
