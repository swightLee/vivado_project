...
(
    ...
    input wire  clk_125_buf,
//    input wire  TX_DATA_OUT,
    (*mark_debug = "TRUE" *)input wire  [3:0] TXCTRL_IN,
    (*mark_debug = "TRUE" *)input wire  [31:0] DATA_FIFO_OUT_GT_IN,
//    input  wire [3:0] gt0_txcharisk_i,
...
//**************************** Wire Declarations ******************************//
    ...
    //---------------- Receive Ports - FPGA RX interface Ports -----------------
     (*mark_debug = "TRUE" *)wire    [31:0]  gt0_rxdata_i;
    ...
    wire    [3:0]   gt0_rxchariscomma_i;
     (*mark_debug = "TRUE" *)wire    [3:0]   gt0_rxcharisk_i;
    //------------ Receive Ports -RX Initialization and Reset Ports ------------
...
assign  q0_clk1_refclk_i                     =  1'b0;
    ...
    .gt0_rxusrclk2_out(gt0_rxusrclk2_i),
        ...
        //---------------- Transmit Ports - TX Data Path interface -----------------
        .gt0_txdata_in                  (DATA_FIFO_OUT_GT_IN),
        //-------------- Transmit Ports - TX Driver and OOB signaling --------------
        ...
        //------------------- Transmit Ports - TX Gearbox Ports --------------------
        .gt0_txcharisk_in               (TXCTRL_IN),
        //----------- Transmit Ports - TX Initialization and Reset Ports -----------
        .gt0_txresetdone_out            (gt0_txresetdone_i),
        //--------------- Transmit Ports - TX Polarity Control Ports ---------------
        .gt0_txpolarity_in              (1'b1),


    //____________________________COMMON PORTS________________________________
    .gt0_qplloutclk_out(),
    .gt0_qplloutrefclk_out(),
    .sysclk_in(clk_125_buf)
    );
